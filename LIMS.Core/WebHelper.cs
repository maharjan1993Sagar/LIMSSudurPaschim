...
namespace LIMS.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual bool IsPostBeingDone {
            get {
                if (_httpContextAccessor.HttpContext.Items["LIMS.IsPOSTBeingDone"] == null)
                    return false;

                return Convert.ToBoolean(_httpContextAccessor.HttpContext.Items["LIMS.IsPOSTBeingDone"]);
            }
            set {
                _httpContextAccessor.HttpContext.Items["LIMS.IsPOSTBeingDone"] = value;
            }
        }
