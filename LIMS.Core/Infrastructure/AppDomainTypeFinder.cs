...
{
    /// <summary>
    /// A class that finds types needed by LIMS by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <returns>A list of assemblies that should be loaded by the LIMS factory.</returns>
