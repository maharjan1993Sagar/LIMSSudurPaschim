...
using LIMS.Core.Roslyn;
using LIMS.Domain.MongoDB;
...
namespace LIMS.Core.Infrastructure
{
    ...
    public static class Engine
    {
        ...
        public static void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var startupConfigurations = typeFinder.FindClassesOfType<ILIMSStartup>();
            ...
            var instances = startupConfigurations
                ...
                .Select(startup => (ILIMSStartup)Activator.CreateInstance(startup))
