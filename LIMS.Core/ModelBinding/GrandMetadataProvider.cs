...
namespace LIMS.Core.ModelBinding
{
    ...
    /// </summary>
    public class LIMSMetadataProvider : IDisplayMetadataProvider
    {
        /// <summary>
        ...
        public void CreateDisplayMetadata(DisplayMetadataProviderContext context)
        {
            ...
            foreach (var additionalValue in additionalValues)
            {
                if (context.DisplayMetadata.AdditionalValues.ContainsKey(additionalValue.Name))
                    throw new LIMSException($"There is already an attribute with the name {additionalValue.Name} on this model");
