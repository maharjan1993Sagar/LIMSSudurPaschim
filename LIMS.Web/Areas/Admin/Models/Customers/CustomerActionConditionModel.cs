...
namespace LIMS.Web.Areas.Admin.Models.Customers
{
    public partial class CustomerActionConditionModel : BaseEntityModel
    {
        ...
        [LIMSResourceDisplayName("Admin.Customers.CustomerActionCondition.Fields.Name")]
        public string Name { get; set; }

        [LIMSResourceDisplayName("Admin.Customers.CustomerActionCondition.Fields.CustomerConditionTypeId")]
        public int CustomerActionConditionTypeId { get; set; }
        public IList<SelectListItem> CustomerActionConditionType { get; set; }

        [LIMSResourceDisplayName("Admin.Customers.CustomerActionCondition.Fields.ConditionId")]
