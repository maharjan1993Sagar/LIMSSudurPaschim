...
namespace LIMS.Web.Areas.Admin.Models.Customers
{
    ...
    {
        [LIMSResourceDisplayName("Admin.Customers.CustomerRoles.Products.Fields.Name")]
        
        public string Name { get; set; }

        public string ProductId { get; set; }

        [LIMSResourceDisplayName("Admin.Customers.CustomerRoles.Products.Fields.DisplayOrder")]
