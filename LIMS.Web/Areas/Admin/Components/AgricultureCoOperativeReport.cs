...
{
    public class AgricultureCoOperativeReport : BaseViewComponent
    {
        #region fields
        ...
        #endregion fields
        #region ctor
        public AgricultureCoOperativeReport(ILocalizationService localizationService,
        ...
        public async Task<IViewComponentResult> InvokeAsync(string fiscalyear)
        {
            ...
            var t = await _agricultureCoOperativeService.GetAgricultureCoOperative("", fiscalyear);           
