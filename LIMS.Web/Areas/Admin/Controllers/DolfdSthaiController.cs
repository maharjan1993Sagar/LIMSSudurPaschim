...
{
    public class DolfdSthaiController : BaseAdminController
    {
        ...
        public DolfdSthaiController(ILocalizationService localizationService,
        ...
        public async Task<IActionResult> Create(DolfdShthaiTahaEntryModel model, IFormCollection col)
        {
