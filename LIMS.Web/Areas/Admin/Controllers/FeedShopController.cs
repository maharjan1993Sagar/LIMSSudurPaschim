...
{
    public class FeedShopController : BaseAdminController
    {
        ...
        public FeedShopController(IOtherOrganizationService organizationService,
        ...
        public async Task<IActionResult> List(DataSourceRequest command,string Keyword)
        {
            ...
            //{
                var hatchery = await _feedIndustryService.GetFeedIndustryByType("", "Feed shop", Keyword, command.Page - 1, command.PageSize);
            ...
            //    var hatchery = await _feedIndustryService.GetFeedIndustryByType(userids, "Feed shop", Keyword, command.Page - 1, command.PageSize);
            //    var gridModel = new DataSourceResult {
            //        Data = hatchery,
            //        ExtraData = Keyword,
            //        Total = hatchery.TotalCount
        ...
        public async Task<ActionResult> Create()
        {
            ...
            var organization = await _organizationService.GetOtherOrganizationByType("", "Feed shop");
