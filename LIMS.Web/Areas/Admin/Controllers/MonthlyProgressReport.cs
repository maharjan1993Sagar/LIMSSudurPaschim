...
{
    public class MonthlyProgressReportController:BaseAdminController
    {
        ...
        #endregion fields
        #region ctor
        public MonthlyProgressReportController(ILocalizationService localizationService,
        ...
        [HttpPost]
        public async Task<IActionResult> Report(string fiscalyear, string month)
        {
            ...
            [HttpPost]
            public virtual IActionResult TreatmentReportHtml(string fiscalyear,string month)
            {
            var livestockWardWiseReportHtml = RenderViewComponentToString("LssTreatmentReport", new { fiscalyear = fiscalyear, month=month });
