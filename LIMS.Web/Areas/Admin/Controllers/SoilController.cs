...
{
    public class SoilController:BaseAdminController
    {
        private readonly ISoilService _animalRegistrationService;
        ...
        public SoilController(ILocalizationService localizationService,
            ISoilService animalRegistrationService,
        ...
        public async Task<IActionResult> Create(SoilModel model, bool continueEditing)
        {
        ...
        [PermissionAuthorizeAction(PermissionActionName.Edit)]
        [HttpPost, ParameterBasedOnFormName("save-continue", "continueEditing")]
        public async Task<IActionResult> Edit(SoilModel model, bool continueEditing)
        {
