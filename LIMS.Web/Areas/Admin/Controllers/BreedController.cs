...
namespace LIMS.Web.Areas.Admin.Controllers
{
    public class BreedController : BaseAdminController
    {
        ...
        public async Task<IActionResult> Create(BreedModel model, bool continueEditing)
        {
            if (ModelState.IsValid)
            {
                var Breed = model.ToEntity();
                Breed.Species = await _SpeciesService.GetSpeciesById(model.SpeciesId);
        ...
        [PermissionAuthorizeAction(PermissionActionName.Edit)]
        [HttpPost, ParameterBasedOnFormName("save-continue", "continueEditing")]
        public async Task<IActionResult> Edit(BreedModel model, bool continueEditing)
        {
