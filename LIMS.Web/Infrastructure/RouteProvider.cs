...
namespace LIMS.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(IEndpointRouteBuilder routeBuilder)
        {
            ...
            {
                var config = routeBuilder.ServiceProvider.GetRequiredService<LIMSConfig>();
            ...
            //home page
            routeBuilder.MapControllerRoute("HomePage", pattern, new { controller = "Login", action = "Index", area = "Admin" });
