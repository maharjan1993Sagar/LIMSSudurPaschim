...
namespace LIMS.Web.Extensions
{
    ...
    //    public static IHtmlContent ForumTopicSmallPager<TModel>(this IHtmlHelper<TModel> html, ILocalizationService localizationService)
    //    {
