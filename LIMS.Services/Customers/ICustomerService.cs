...
namespace LIMS.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        List<Customer> GetCustomerByLssId(List<string> Lssid, string vhlsecid);
        /// <summary>
        ...
        List<Customer> GetCustomerByLssId(List<string> lssid, List<string> vhlsecId, string dolfdId);
        List<Customer> GetNlboUsers();
        /// <summary>
        /// Delete a customer
        /// </summary>
