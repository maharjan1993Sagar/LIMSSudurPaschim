...
namespace LIMS.Services.Customers
{
    ...
    public partial class CustomerAttributeService : ICustomerAttributeService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string CUSTOMERATTRIBUTES_ALL_KEY = "LIMS.customerattribute.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string CUSTOMERATTRIBUTES_BY_ID_KEY = "LIMS.customerattribute.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CUSTOMERATTRIBUTES_PATTERN_KEY = "LIMS.customerattribute.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CUSTOMERATTRIBUTEVALUES_PATTERN_KEY = "LIMS.customerattributevalue.";
        #endregion
