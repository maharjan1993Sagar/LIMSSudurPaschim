...
namespace LIMS.Services.Security
{
    ...
    public partial class PermissionService : IPermissionService
    {
        ...
        /// </remarks>
        private const string PERMISSIONS_ALLOWED_KEY = "LIMS.permission.allowed-{0}-{1}";
        ...
        /// </remarks>
        private const string PERMISSIONS_ALLOWED_ACTION_KEY = "LIMS.permission.allowed.action-{0}-{1}-{2}";

        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string PERMISSIONS_PATTERN_KEY = "LIMS.permission.";
        #endregion
