...
namespace LIMS.Services.Directory
{
    ...
    public partial class StateProvinceService : IStateProvinceService
    {
        ...
        /// {0} : state ID
        /// </remarks>
        private const string STATEPROVINCES_BY_KEY = "LIMS.stateprovince.{0}";

        /// {0} : country ID
        /// {1} : language ID
        /// {2} : show hidden records?
        /// </remarks>
        private const string STATEPROVINCES_ALL_KEY = "LIMS.stateprovince.all-{0}-{1}-{2}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string STATEPROVINCES_PATTERN_KEY = "LIMS.stateprovince.";
