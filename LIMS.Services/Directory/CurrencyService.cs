...
namespace LIMS.Services.Directory
{
    ...
    public partial class CurrencyService : ICurrencyService
    {
        ...
        /// {0} : currency ID
        /// </remarks>
        private const string CURRENCIES_BY_ID_KEY = "LIMS.currency.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : currency code
        /// </remarks>
        private const string CURRENCIES_BY_CODE = "LIMS.currency.code-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string CURRENCIES_ALL_KEY = "LIMS.currency.all-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CURRENCIES_PATTERN_KEY = "LIMS.currency.";
        ...
        public virtual async Task<decimal> ConvertToPrimaryExchangeRateCurrency(decimal amount, Currency sourceCurrencyCode)
        {
            ...
            if (exchangeRate == decimal.Zero)
                throw new LIMSException(string.Format("Exchange rate not found for currency [{0}]", sourceCurrencyCode.Name));
        ...
        public virtual async Task<decimal> ConvertFromPrimaryExchangeRateCurrency(decimal amount, Currency targetCurrencyCode)
        {
            ...
            if (exchangeRate == decimal.Zero)
                throw new LIMSException(string.Format("Exchange rate not found for currency [{0}]", targetCurrencyCode.Name));
