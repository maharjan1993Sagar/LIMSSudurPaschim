...
namespace LIMS.Services.Directory
{
    ...
    public partial class CountryService : ICountryService
    {
        ...
        /// </remarks>
        private const string COUNTRIES_ALL_KEY = "LIMS.country.all-{0}-{1}";
        ...
        /// {0} : country ID
        /// </remarks>
        private static string COUNTRIES_BY_KEY = "LIMS.country.id-{0}";
        ...
        /// {0} : twoletter
        /// </remarks>
        private static string COUNTRIES_BY_TWOLETTER = "LIMS.country.twoletter-{0}";
        ...
        /// {0} : threeletter
        /// </remarks>
        private static string COUNTRIES_BY_THREELETTER = "LIMS.country.threeletter-{0}";

        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string COUNTRIES_PATTERN_KEY = "LIMS.country.";
