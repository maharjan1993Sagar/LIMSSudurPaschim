using LIMS.Core.Http;
using Microsoft.AspNetCore.Http;
using System.Collections.Generic;

namespace LIMS.Services.Authentication.External
{
    /// <summary>
    ...
    public static partial class ExternalAuthorizerHelper
    {
        ...
        /// </summary>
        private const string EXTERNAL_AUTHENTICATION_PARAMETERS = "LIMS.externalauth.parameters";

        /// <summary>
        /// Key for store external authentication errors to session
        /// </summary>
        private const string EXTERNAL_AUTHENTICATION_ERRORS = "LIMS.externalauth.errors";
