...
namespace LIMS.Services.Bali
{
    public interface IMonthlyPragatiService
    {
        ...
        Task<IPagedList<MonthlyPragati>> GetFilteredMonthlyPragati(string createdby, string fiscalYear, string sourceOfFund, string typeOfExpense, string month, string expenseCategory = "", string xetra = "", int pageIndex = 0, int pageSize = int.MaxValue);
