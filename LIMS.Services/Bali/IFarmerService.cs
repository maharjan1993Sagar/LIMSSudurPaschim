...
namespace LIMS.Services.Bali
{
    public interface IFarmerService
    {
        ...
        Task<IPagedList<Farmer>> GetfarmerByPugigatType(string createdby, string localLevel, string budgetId, string fiscalyear,string talimId,string xetra, int pageIndex = 0, int pageSize = int.MaxValue);
