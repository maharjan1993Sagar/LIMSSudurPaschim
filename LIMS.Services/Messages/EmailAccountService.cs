...
namespace LIMS.Services.Messages
{
    public partial class EmailAccountService : IEmailAccountService
    {
        ...
        /// {0} : email account ID
        /// </remarks>
        private const string EMAILACCOUNT_BY_ID_KEY = "LIMS.emailaccount.id-{0}";
        ...
        /// <remarks>
        /// </remarks>
        private const string EMAILACCOUNT_ALL_KEY = "LIMS.emailaccount.all";

        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string EMAILACCOUNT_PATTERN_KEY = "LIMS.emailaccount.";
        ...
        public virtual async Task DeleteEmailAccount(EmailAccount emailAccount)
        {
            ...
            if (emailAccounts.Count == 1)
                throw new LIMSException("You cannot delete this email account. At least one account is required.");
