...
using LIMS.Services.Commands.Models.Customers;
...
namespace LIMS.Services.Commands.Handlers.Customers
{
    public class CustomerActionEventReactionCommandHandler : IRequestHandler<CustomerActionEventReactionCommand, bool>
    {
        ...
        public async Task Reaction(IList<CustomerActionType> customerActionTypes, CustomerAction action, string customerId)
        {
