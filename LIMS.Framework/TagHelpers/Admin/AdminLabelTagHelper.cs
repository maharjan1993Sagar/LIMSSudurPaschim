...
namespace LIMS.Framework.TagHelpers.Admin
{
    ...
    public class LabelRequiredTagHelper : LabelTagHelper
    {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (For.Metadata.AdditionalValues.TryGetValue("LIMSResourceDisplayNameAttribute", out object value))
            {
                var resourceDisplayName = value as LIMSResourceDisplayNameAttribute;
