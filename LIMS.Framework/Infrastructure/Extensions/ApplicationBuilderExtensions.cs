...
namespace LIMS.Framework.Infrastructure.Extensions
{
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseLIMSExceptionHandler(this IApplicationBuilder application)
        {
            var serviceProvider = application.ApplicationServices;
            var LIMSConfig = serviceProvider.GetRequiredService<LIMSConfig>();
            var hostingEnvironment = serviceProvider.GetRequiredService<IWebHostEnvironment>();
            var useDetailedExceptionPage = LIMSConfig.DisplayFullErrorStack || hostingEnvironment.IsDevelopment();
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseLIMSAuthentication(this IApplicationBuilder application)
        {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseLIMSEndpoints(this IApplicationBuilder application)
        {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseLIMSStaticFiles(this IApplicationBuilder application, LIMSConfig LIMSConfig)
        {
            //static files
            application.UseStaticFiles(new StaticFileOptions {
                ...
                {
                    if (!String.IsNullOrEmpty(LIMSConfig.StaticFilesCacheControl))
                        ctx.Context.Response.Headers.Append(HeaderNames.CacheControl, LIMSConfig.StaticFilesCacheControl);
                }
        ...
        public static void UseProfiler(this IApplicationBuilder application)
        {
            ...
            var LIMSConfig = application.ApplicationServices.GetRequiredService<LIMSConfig>();
            //whether MiniProfiler should be displayed
            if (LIMSConfig.DisplayMiniProfilerInPublicStore)
            {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseLIMSForwardedHeaders(this IApplicationBuilder application)
        {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseLIMSHealthChecks(this IApplicationBuilder application)
        {
