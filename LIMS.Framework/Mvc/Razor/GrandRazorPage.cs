...
namespace LIMS.Framework.Mvc.Razor
{
    /// <summary>
    /// Web view page
    /// </summary>
    /// <typeparam name="TModel">Model</typeparam>
    public abstract class LIMSRazorPage<TModel> : Microsoft.AspNetCore.Mvc.Razor.RazorPage<TModel>
    {
        ...
        public int GetSelectedTabIndex()
        {
            ...
            //"SetSelectedTabIndex" method of \Administration\Controllers\BaseLIMSController.cs
            int index = 0;
            string dataKey = "LIMS.selected-tab-index";
