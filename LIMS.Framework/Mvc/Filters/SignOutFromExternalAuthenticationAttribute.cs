...
namespace LIMS.Framework.Mvc.Filters
{
    /// <summary>
    ...
    public class SignOutFromExternalAuthenticationAttribute : TypeFilterAttribute
    {
        ...
        private class SignOutFromExternalAuthenticationFilter : IAuthorizationFilter
        {
            ...
            public async void OnAuthorization(AuthorizationFilterContext filterContext)
            {
                ...
                var authenticateResult = await filterContext.HttpContext.AuthenticateAsync(LIMSCookieAuthenticationDefaults.ExternalAuthenticationScheme);
                if (authenticateResult.Succeeded)
                    await filterContext.HttpContext.SignOutAsync(LIMSCookieAuthenticationDefaults.ExternalAuthenticationScheme);
            }
