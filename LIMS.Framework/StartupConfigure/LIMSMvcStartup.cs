...
namespace LIMS.Framework.StartupConfigure
{
    ...
    /// </summary>
    public class LIMSMvcStartup : ILIMSStartup
    {
        /// <summary>
        ...
        {
            //add healthChecks
            services.AddLIMSHealthChecks();

            //add miniprofiler
            services.AddLIMSMiniProfiler();
            ...
            services.AddLIMSMvc(configuration);

            //add pwa
            services.AddPWA(configuration);

            //add custom redirect result executor
            services.AddLIMSRedirectResultExecutor();
