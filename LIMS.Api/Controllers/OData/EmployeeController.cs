...
namespace LIMS.Api.Controllers.OData
{
        ...
        [SwaggerTag(description: "Get Employee")]
    public class EmployeeController : BaseODataController
    {
        ...
        {
            return Ok(await _mediator.Send(new GetQueryCMS<EmployeeDto>() {UserId=userId }));
        }
    }
}
