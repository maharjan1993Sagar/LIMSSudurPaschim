...
{
    public class AddPregnencyDiagnosisCommandHandler: IRequestHandler<AddPregnencyDiagnosisCommand, PregnencyDiagnosisDto>
    {
        private readonly IAnimalRegistrationService _animalRegistrationService;
        private readonly IWorkContext _workContext;
        private readonly IPregnencyDiagnosisService _aiService;
        private readonly ISpeciesService _speciesService;
        private readonly IBreedService _breedService;
        private readonly IFiscalYearService _fiscalYearService;

        public AddPregnencyDiagnosisCommandHandler(
            IAnimalRegistrationService animalRegistrationService,
            IFarmService farmService,
            IWorkContext workContext,
            IFiscalYearService fiscalYearService,
            IPregnencyDiagnosisService aiService,
        ...
        public async Task<PregnencyDiagnosisDto> Handle(AddPregnencyDiagnosisCommand request, CancellationToken cancellationToken)
        {
            ...
            await _aiService.InsertPregnencyDiagnosis(aiService);
            //activity log
