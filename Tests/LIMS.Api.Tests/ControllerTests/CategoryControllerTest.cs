//using LIMS.Api.DTOs.Catalog;
//using LIMS.Api.Interfaces;
//using LIMS.Api.Tests.Helpers;
//using LIMS.Core.Data;
//using LIMS.Core.Domain.Catalog;
//using LIMS.Services.Security;
//using LIMS.Services.Tests;
//using LIMS.Web.Areas.Api.Controllers.OData;
...
//namespace LIMS.Api.Tests.ControllerTests
//{
//    [TestClass]
